package com.masoudnaji.easysmartpdf.ui.screens.success
...
fun SuccessScreen(
    ...
    Scaffold(modifier = modifier) { innerPadding ->
        Column(
            ...
            Text(
                text = stringResource(R.string.success_pictures_count, savedCount),
            ...
            Text(
                text = stringResource(R.string.success_folder, folderName),
